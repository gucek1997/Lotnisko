...
$sql = "SELECT id FROM cleaner WHERE user='".$_SESSION['user']."'";
...
$sql = <<<EOT
	...
	from cleaner_has_czas_pracy 
	inner join czas_pracy 
	on cleaner_has_czas_pracy.Czas_Pracy_id = czas_pracy.id 
	where cleaner_has_czas_pracy.Obsluga_sprzatajaca_id =
EOT;
