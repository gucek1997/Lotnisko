<?php
	...
	if (isset($_POST['email']))
	{
		...
		// recaptcha
		$sekret = "6Lfsn1AUAAAAAPyy-_pKNn47bEpF1Bn5P03CenCb";
		...
		{
			$wszystko_ok=false;
			$_SESSION['e_captha']= "Potwierdź, że nie jesteś botem !";	
		}
...
?>
 ...
 <div id="tekstrejestracja">  Wypełnij formularz rejestracyjny podając swoje dane osobowe. Po rejestracji będziesz mógł zalogować się na swoje konto. </div>
...
<div id="rejestracja">
	...
	<br/> 
	<br/> 
	<div class="g-recaptcha" data-sitekey="6Lfsn1AUAAAAAFOKnGvV1-IshUWlbhX1rH7DfDvN"></div>
	<?php
	...
	<div class="checkbox">
		<label><input type="checkbox" value="" name="regulamin"><b>Akceptuję regulamin</b></label>
	</div>
	...
	<br/>
	<br/ > 
	<input type = "submit" value="Zarejestruj się" class="btn btn-success .btn-lg" />
	</form>
	</div>
